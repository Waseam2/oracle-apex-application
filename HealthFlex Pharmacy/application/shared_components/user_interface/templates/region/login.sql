...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6799985397922777)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6800244195922778)
,p_plug_template_id=>wwv_flow_imp.id(6799985397922777)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6800545676922778)
,p_plug_template_id=>wwv_flow_imp.id(6799985397922777)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6800925530922780)
,p_plug_template_id=>wwv_flow_imp.id(6799985397922777)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6801192132922780)
,p_plug_template_id=>wwv_flow_imp.id(6799985397922777)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6801473335922781)
,p_plug_template_id=>wwv_flow_imp.id(6799985397922777)
,p_name=>'Sub Regions'
