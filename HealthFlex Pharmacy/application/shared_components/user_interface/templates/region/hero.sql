...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6774661697922689)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6774977326922692)
,p_plug_template_id=>wwv_flow_imp.id(6774661697922689)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6775279299922692)
,p_plug_template_id=>wwv_flow_imp.id(6774661697922689)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6775584478922692)
,p_plug_template_id=>wwv_flow_imp.id(6774661697922689)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6775929535922694)
,p_plug_template_id=>wwv_flow_imp.id(6774661697922689)
,p_name=>'Sub Regions'
