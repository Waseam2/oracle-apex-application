...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6812297043922805)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6812556337922806)
,p_plug_template_id=>wwv_flow_imp.id(6812297043922805)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6812900457922806)
,p_plug_template_id=>wwv_flow_imp.id(6812297043922805)
,p_name=>'Tabs'
