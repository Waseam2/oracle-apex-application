...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6749154318922580)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6749507328922581)
,p_plug_template_id=>wwv_flow_imp.id(6749154318922580)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6749825313922581)
,p_plug_template_id=>wwv_flow_imp.id(6749154318922580)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6750100159922583)
,p_plug_template_id=>wwv_flow_imp.id(6749154318922580)
,p_name=>'Sub Regions'
