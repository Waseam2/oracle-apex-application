...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6777891238922703)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6778132483922703)
,p_plug_template_id=>wwv_flow_imp.id(6777891238922703)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6778472731922711)
,p_plug_template_id=>wwv_flow_imp.id(6777891238922703)
,p_name=>'Sub Regions'
