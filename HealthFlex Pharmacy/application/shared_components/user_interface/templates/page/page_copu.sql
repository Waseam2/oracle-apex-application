prompt --application/shared_components/user_interface/templates/page/page_copu
begin
--   Manifest
--     TEMPLATE: PAGE_COPU
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(16701158532737384)
,p_theme_id=>42
,p_name=>'page copu'
,p_internal_name=>'PAGE_COPU'
,p_is_popup=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16701595583737429)
,p_page_template_id=>wwv_flow_imp.id(16701158532737384)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16702073961737434)
,p_page_template_id=>wwv_flow_imp.id(16701158532737384)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16702582062737434)
,p_page_template_id=>wwv_flow_imp.id(16701158532737384)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16703085672737434)
,p_page_template_id=>wwv_flow_imp.id(16701158532737384)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16703541442737434)
,p_page_template_id=>wwv_flow_imp.id(16701158532737384)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16704084673737435)
,p_page_template_id=>wwv_flow_imp.id(16701158532737384)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16704593250737435)
,p_page_template_id=>wwv_flow_imp.id(16701158532737384)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16705097194737435)
,p_page_template_id=>wwv_flow_imp.id(16701158532737384)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16705540462737435)
,p_page_template_id=>wwv_flow_imp.id(16701158532737384)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16706019390737437)
,p_page_template_id=>wwv_flow_imp.id(16701158532737384)
