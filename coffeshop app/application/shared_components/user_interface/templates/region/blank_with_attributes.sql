...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(39412017099159735375)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912459485539519421)
,p_plug_template_id=>wwv_flow_imp.id(39412017099159735375)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912459977108519421)
,p_plug_template_id=>wwv_flow_imp.id(39412017099159735375)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912460499675519422)
,p_plug_template_id=>wwv_flow_imp.id(39412017099159735375)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912460939497519422)
,p_plug_template_id=>wwv_flow_imp.id(39412017099159735375)
,p_name=>'Sub Regions'
