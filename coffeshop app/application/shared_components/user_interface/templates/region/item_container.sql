...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(40264942967678015858)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912609778532519497)
,p_plug_template_id=>wwv_flow_imp.id(40264942967678015858)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912610217702519497)
,p_plug_template_id=>wwv_flow_imp.id(40264942967678015858)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912610781720519497)
,p_plug_template_id=>wwv_flow_imp.id(40264942967678015858)
,p_name=>'Button Start'
