...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(39412094714659735777)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912676974774519530)
,p_plug_template_id=>wwv_flow_imp.id(39412094714659735777)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912677477641519530)
,p_plug_template_id=>wwv_flow_imp.id(39412094714659735777)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912677967804519530)
,p_plug_template_id=>wwv_flow_imp.id(39412094714659735777)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912678448653519531)
,p_plug_template_id=>wwv_flow_imp.id(39412094714659735777)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912678907145519531)
,p_plug_template_id=>wwv_flow_imp.id(39412094714659735777)
