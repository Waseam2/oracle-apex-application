...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(39412052868392735589)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912552763538519469)
,p_plug_template_id=>wwv_flow_imp.id(39412052868392735589)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912553290293519469)
,p_plug_template_id=>wwv_flow_imp.id(39412052868392735589)
,p_name=>'Sub Regions'
