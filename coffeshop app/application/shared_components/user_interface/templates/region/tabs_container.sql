...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(39412087280896735748)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912656357949519520)
,p_plug_template_id=>wwv_flow_imp.id(39412087280896735748)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912656873615519520)
,p_plug_template_id=>wwv_flow_imp.id(39412087280896735748)
,p_name=>'Tabs'
