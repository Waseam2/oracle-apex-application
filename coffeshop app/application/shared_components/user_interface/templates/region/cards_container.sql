...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(39412024155497735411)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912478023335519431)
,p_plug_template_id=>wwv_flow_imp.id(39412024155497735411)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912478554562519431)
,p_plug_template_id=>wwv_flow_imp.id(39412024155497735411)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912479021002519431)
,p_plug_template_id=>wwv_flow_imp.id(39412024155497735411)
,p_name=>'Sub Regions'
