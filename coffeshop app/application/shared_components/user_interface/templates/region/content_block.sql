...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(39412045486433735555)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912534944889519460)
,p_plug_template_id=>wwv_flow_imp.id(39412045486433735555)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912535452005519460)
,p_plug_template_id=>wwv_flow_imp.id(39412045486433735555)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912535911368519460)
,p_plug_template_id=>wwv_flow_imp.id(39412045486433735555)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912536451026519461)
,p_plug_template_id=>wwv_flow_imp.id(39412045486433735555)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912536900274519461)
,p_plug_template_id=>wwv_flow_imp.id(39412045486433735555)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912537492617519461)
,p_plug_template_id=>wwv_flow_imp.id(39412045486433735555)
,p_name=>'Sub Regions'
