...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(39412074920648735698)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912616570470519500)
,p_plug_template_id=>wwv_flow_imp.id(39412074920648735698)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912617081941519500)
,p_plug_template_id=>wwv_flow_imp.id(39412074920648735698)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912617532261519501)
,p_plug_template_id=>wwv_flow_imp.id(39412074920648735698)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912618045597519501)
,p_plug_template_id=>wwv_flow_imp.id(39412074920648735698)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912618558836519501)
,p_plug_template_id=>wwv_flow_imp.id(39412074920648735698)
,p_name=>'Sub Regions'
