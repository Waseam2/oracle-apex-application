...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(39412018485207735381)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912463492862519423)
,p_plug_template_id=>wwv_flow_imp.id(39412018485207735381)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912463951772519423)
,p_plug_template_id=>wwv_flow_imp.id(39412018485207735381)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912464437275519423)
,p_plug_template_id=>wwv_flow_imp.id(39412018485207735381)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912464956007519424)
,p_plug_template_id=>wwv_flow_imp.id(39412018485207735381)
,p_name=>'Sub Regions'
