...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(39412049667263735573)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912545227582519465)
,p_plug_template_id=>wwv_flow_imp.id(39412049667263735573)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912545732316519465)
,p_plug_template_id=>wwv_flow_imp.id(39412049667263735573)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912546281802519466)
,p_plug_template_id=>wwv_flow_imp.id(39412049667263735573)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912546733430519466)
,p_plug_template_id=>wwv_flow_imp.id(39412049667263735573)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912547262437519466)
,p_plug_template_id=>wwv_flow_imp.id(39412049667263735573)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
