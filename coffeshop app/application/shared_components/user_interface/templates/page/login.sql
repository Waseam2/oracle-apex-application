...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(39411989602172735189)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912391975977519386)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912392417029519386)
,p_page_template_id=>wwv_flow_imp.id(39411989602172735189)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912392977033519386)
,p_page_template_id=>wwv_flow_imp.id(39411989602172735189)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912393419098519386)
,p_page_template_id=>wwv_flow_imp.id(39411989602172735189)
,p_name=>'Body Footer'
