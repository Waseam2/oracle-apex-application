...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(39411992194500735202)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912442667555519410)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912443197264519410)
,p_page_template_id=>wwv_flow_imp.id(39411992194500735202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912443637896519410)
,p_page_template_id=>wwv_flow_imp.id(39411992194500735202)
