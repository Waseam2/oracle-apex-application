...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(39411988031681735172)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912418897960519399)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912419315998519399)
,p_page_template_id=>wwv_flow_imp.id(39411988031681735172)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912419803844519399)
,p_page_template_id=>wwv_flow_imp.id(39411988031681735172)
