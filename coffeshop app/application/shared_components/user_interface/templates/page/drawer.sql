...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(39411981200535734945)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912362585789519372)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912363028882519373)
,p_page_template_id=>wwv_flow_imp.id(39411981200535734945)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(57912363596249519373)
,p_page_template_id=>wwv_flow_imp.id(39411981200535734945)
