...
@@application/shared_components/files/png_clipart_table_dining_room_computer_icons_chair_furniture_table_angle_kitchen_png.sql
@@application/shared_components/files/icons_tableicone_png.sql
@@application/shared_components/files/apex_data_pkg_التربيزات_675340_zip.sql
@@application/shared_components/files/apex_data_pkg_الطلبات_575263_zip.sql
@@application/shared_components/files/apex_data_pkg_الفاتوره_41368_zip.sql
@@application/shared_components/files/apex_data_pkg_المشروبات_936813_zip.sql
@@application/shared_components/files/apex_data_pkg_طلبات_مشروبات_117555_zip.sql
